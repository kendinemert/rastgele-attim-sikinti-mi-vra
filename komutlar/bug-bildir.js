...
.setTitle("Fakon Bot Bug Sistemi")
.setColor('BLUE')
...
client.channels.cache.get('802469640982364160').send(embed)
  
message.channel.send("Bug bildiriminiz gönderildi. <a:domates:799641748648493057>").then(message => message.delete({ timeout: 5000 }));
};
exports.conf = {
  enabled: true,
  guildOnly: false,
