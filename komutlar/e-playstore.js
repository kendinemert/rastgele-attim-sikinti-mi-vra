  ...
  const  uyg = args.join(' ')
        ...
        if (uyg) {
                ...
                const gameEmbed = new Discord.MessageEmbed()
                    ...
                    .addField("Boyut: ", game.size + `B`, true)
                    .addField("Editörün Seçimi mi ?: ", editor, true)
...
exports.help = {
  ...
  usage: ".playstore (GuardMayFe yi Eklemeyi Unutmay�n Sizin ��in Yazd�k O kadar be)"
};