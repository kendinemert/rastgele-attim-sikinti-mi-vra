...
if(!datas) return message.channel.send(new Discord.MessageEmbed().setTitle('Bir hata oldu!').setDescription(`**${ayarlar.prefix}erkek-role @roleetiket** olarak erkek rolünü aktif etmelisin!`).setFooter('Erkek rolü aktif değil', message.author.avatarURL() ? message.author.avatarURL({dynamic: true}) : 'https://cdn.glitch.com/8e70d198-9ddc-40aa-b0c6-ccb4573f14a4%2F6499d2f1c46b106eed1e25892568aa55.png'))
if(!datass) return message.channel.send(new Discord.MessageEmbed().setTitle('Bir hata oldu!').setDescription(`**${ayarlar.prefix}kadın-role @roleetiket** olarak erkek rolünü aktif etmelisin!`).setFooter('Kadın rolü aktif değil', message.author.avatarURL() ? message.author.avatarURL({dynamic: true}) : 'https://cdn.glitch.com/8e70d198-9ddc-40aa-b0c6-ccb4573f14a4%2F6499d2f1c46b106eed1e25892568aa55.png'))
...
.setDescription(`\`\`\`[${ayarlar.prefix}kayıt-tag] ile taglı sayını ayarlayabilirsin.\`\`\`
